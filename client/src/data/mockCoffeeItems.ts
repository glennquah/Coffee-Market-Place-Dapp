...
const coffeeMockCart: CoffeeCardProps[] = [
   {
    type: 'cart',
  ...
  {
    type: 'cart',
    imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfb174Q7aM37jOW6ddJJ_ueKGKhcCRk-2_WQ&s',
    name: 'Classic Espresso Beans',
    price: '0.005134',
    numberOfNFT: 7,
    id: 3,
    qty: 10,
